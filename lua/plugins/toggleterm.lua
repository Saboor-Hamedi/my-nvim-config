...
function M.config()
  ...
  for i, exec in pairs(execs) do
    ...
    local opts = {
      ...
      direction = direction,
      size = function()
        return get_dynamic_terminal_size(direction, exec[5]) end,
    }
  ...
  require("toggleterm").setup {
    ...
    shading_factor = 1.5, -- the degree by which to darken to terminal colour, default: 1 for dark backgrounds, 3 for light
